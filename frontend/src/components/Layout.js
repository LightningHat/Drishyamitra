    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      <aside className="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col p-6">
        ...
        <button 
          ...
          className="flex items-center space-x-3 p-3 text-slate-400 hover:text-red-500 transition-colors mt-auto font-medium text-sm"
        >
          <LogOut size={18} />
          <span>Sign Out</span>
        </button>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
          <div className="text-slate-400 text-sm italic">AI Photo Management System</div>
